...
const App = ({ dataNotification, auth, onExitApp, langTranslate }) => {
  const exitApp = useHTSSelector((state) => state.app.exitApp);
  const [loading, setLoading] = useState(true);
  const { setAction, setAuth } = useContext(HTSContext);
